    ...
    return (
        <div>
            <div className={"grid grid-cols-1 lg:grid-cols-2 gap-3 my-4"}>
                <Card badgeText={"Installation"} href={"/unmodded-distros/unmodded-os-installation"} className={""} title={"Install an OS with Andronix"}
                ...
                <Card badgeText={"Tutorial"} href={"/android-12/andronix-on-android-12-and-beyond"} className={""} title={"Process complete- Error Termux"}
                      icon={RiTerminalBoxFill}>Learn how to resolve "Process completed (signal 9) - press Enter" error.</Card>
                <Card badgeText={"Error"} href={"/termux/migrating-to-f-droid"} className={""} title={"How to install Termux"} icon={SiAndroid}>Learn how to install Termux app from the F-Droid store to ensure compatibility.</Card>
            </div>
        </div>
    )
}
