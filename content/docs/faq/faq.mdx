...
phantom process killer. Please read [this page of the documentation](/android-12/andronix-on-android-12-and-beyond) to mitigate this. You can also follow the video guide (https://youtu.be/mjXSh3yq-I0) to fix it on your device.
...
```
___
### 7. Ubuntu 20.04: Firefox shows Gah. Your tab just crashed
...
<Imagera src="/images/faq/firefox.png" height={500}/>
6. Restart Firefox.
