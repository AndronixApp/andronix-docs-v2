...
1. Download the Modded OS file.
2. Set up the user, locale, and other required things.
3. Start the distro with ./andro*distro*.sh
4. Start the VNC server and connect to it using a VNC-viewer.
